...
|---|---|---|
| Detect | [Harbor Watch](case-studies/harbor-watch.md) | Turns daily transaction monitoring into an exception-based review process with human decisions and an audit trail. |
