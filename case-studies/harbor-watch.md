# Harbor Watch: Transaction Risk Monitoring
...
Harbor Watch converts daily bank activity into a controlled exception-review workflow. It evaluates new transactions, opens review items when attention is required, reminds reviewers about unresolved items, and preserves the final disposition in an audit trail.
